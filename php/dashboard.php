...
function updateAdress(){
    echo'<form method="post" action="dashboard.php">
             <h1>Add an Adress</h1><br>
                ...
                <input type="int" id="Postalcode" placeholder="Postalcode" name="postalcode" maxlength="50" required>
...
function updateCredit(){
    echo'<form method="post" action="dashboard.php">
             <h1>Add an creditCard</h1><br>
                <input type="int" id="creditcard" placeholder="creditcard" name="creditcard" maxlength="50" required>
          ...
          if ($result->rowCount() > 0){
            ...
            if ($check->rowCount() > 0){
              echo'inserito';
                 ...
                 $check->bindParam(5, $postalcode, PDO::PARAM_INT);
                 $check->execute();
            }if($check->rowCount() > 0) {
                 $msg = 'Inserito';
                } else {
